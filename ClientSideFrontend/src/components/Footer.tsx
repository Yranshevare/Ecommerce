...
const Footer = () => {
    return (
        <footer className="bg-stone-800 text-stone-50 lg:px-20 px-5">
            {/* Newsletter Section */}
            {/* <div className="border-b border-stone-50/10">
                <div className="container py-16">
                    <div className="max-w-xl mx-auto text-center">
                        <h3 className="text-2xl md:text-3xl font-serif font-semibold mb-4">Join Our Newsletter</h3>
                        <p className="text-stone-50/70 mb-6">Subscribe for exclusive offers, new arrivals, and home styling tips.</p>
            ...
            <div className="container py-12">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                    ...
                    <div className="col-span-2 md:col-span-1">
                        <span className="font-serif text-2xl font-semibold"><img src="/footerLogo.png" alt="" className="h-15"/></span>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3 text-sm text-stone-50/70">
                            <li>
                                <a href="/products" className="hover:text-stone-50 transition-colors">
                                    Bedsheets
                                </a>
                            </li>
                            <li>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3 text-sm text-stone-50/70">
                            <li>
                                <a href="/About#contact" className="hover:text-stone-50 transition-colors">
                                    Contact Us
                                </a>
                            </li>
                            <li>
                ...
                <div className="border-t border-stone-50/10 mt-12 pt-8 text-center text-sm text-stone-50/50">
                    <p>© 2024 Ojha Signatures. All rights reserved.</p>
                </div>
            </div>
        </footer>
    );
